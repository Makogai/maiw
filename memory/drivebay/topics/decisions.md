...
|---|---|---|---|---|
| 2026-07-28 | Moderation warnings + selling restrictions email on issue/lift/expire via shared `ModerationNoticeMail` (**Jira: KAN-60**) | In-app/push alone miss users offline | Ban/suspend/report emails still out of scope | `UserWarningService`, `UserSellingRestrictionService`, `docs/development/transactional-emails.md` |
